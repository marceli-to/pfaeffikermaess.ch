...
<meta property="og:image" content="{{ env('APP_URL') }}/media/img/pfaeffikermaess-2024-og.jpg">
...
<body class="antialiased font-regular text-white text-base lg:text-md leading-[1.35] flex min-h-full flex-col">
